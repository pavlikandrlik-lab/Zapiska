...
/// <summary>
/// Partial OpenXmlWordExportService — cover page, project metadata header a attendance section.
/// </summary>
public sealed partial class OpenXmlWordExportService
{
    ...
    private void AppendHeader(Body body, PdfExportTemplateViewModel model, string documentTitle)
    {
        var variant = (model.ExportVariant ?? "project_all").Trim().ToLowerInvariant();
